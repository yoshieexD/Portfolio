...
export const LinkedInIcon = () => {
    return (
        <svg
            ...
            height="20px"
            role="img"
            style={{ color: 'currentColor', display: 'inline-block', verticalAlign: 'middle' }}
        >
            <g fill="currentColor">
